...
public class CreateReactController {
  private static final Logger log = LogManager.getLogger(CreateReactController.class);

  @Autowired
	private JwtUtils jwtUtils;

  @Autowired
  private CreateReactService createReactService;

  @Autowired
  private GetReactService getReactService;

  @PostMapping("/createReact")
  public CommonResponse<Object> createReact(@RequestBody CreateReactRequest request, @RequestHeader Map<String, String> header){
    CommonResponse<Object> response = new CommonResponse<Object>();
      try {
        ...
        response =createReactService.createReact(request, username);
  ...
  @PostMapping(value="/getReact")
  public CommonResponse<Object> getReact(@RequestBody GetReactRequest request,@RequestHeader Map<String, String> header) {
      ...
      try {
        ...
        response = getReactService.getReacts(request, username);
