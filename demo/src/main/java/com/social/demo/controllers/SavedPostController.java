...
public class SavedPostController {
  private static final Logger log = LogManager.getLogger(SavedPostController.class);
  ...
  @PostMapping("/saveOrUnsavePost")
  public CommonResponse<Object> saveOrUnsavePost(@RequestBody SavedPostRequest request, @RequestHeader Map<String, String> header){
    CommonResponse<Object> response = new CommonResponse<Object>();
      try {
        ...
        response = savedPostService.saveOrUnsavePost(request, username);
  ...
  @PostMapping("/getSavePost")
  public CommonResponse<Object> getSavePost(@RequestBody SavedPostRequest request, @RequestHeader Map<String, String> header){
    CommonResponse<Object> response = new CommonResponse<Object>();
      try {
        String bearerToken = header.get("authorization");
  			log.info("-------> bearerToken {}", bearerToken);
